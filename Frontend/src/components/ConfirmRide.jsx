 ...
 const ConfirmRide = ({fare,vehicleType,pickup,destination,setVehicleFound,setConfirmRidePanel,createRide,setVehiclePanel }) => {
    const image = {
   ...
   return (
     <div>
        ...
        <div className='flex gap-2 justify-between items-center flex-col'>
            <img className='h-20' src={image[vehicleType]} alt="" />
            ...
            <button onClick={()=>{setVehicleFound(true); setConfirmRidePanel(false); createRide(vehicleType)}} className='w-full mt-5 bg-green-600 text-white font-semibold p-2 rounded-lg'>Confirm</button>
        </div>
     </div>
   )
 }
